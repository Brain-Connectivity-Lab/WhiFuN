function whifun_normalise(now_anat_path,now_func_path,name,nt,vox,Norm_pre,skull_pre,func_anat)
...
if func_anat == 1
    ...
    matlabbatch{1}.spm.spatial.normalise.write.subj.resample = {complete_filepath(fullfile(now_anat_path.folder,[skull_pre name '.nii']))};
end
